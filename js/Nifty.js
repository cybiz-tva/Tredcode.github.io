...
function call_Expiry_API(script) {
  $.post(
    "https://students.tradingcafeindia.com/tc_indicator/get_running_expiry",
    { script: script },
...
function call_Candlestick_API(script) {
  $.post(
    "https://students.tradingcafeindia.com/tc_indicator/chart",
    { script: script },
    function (data, status) {
      Candle_data = data;
...
function call_Volume_API(script, exp_date) {
  $.post(
    "https://students.tradingcafeindia.com/tc_indicator/op_histogram",
...
function call_Bottom_Right_Bar_API(script, exp_date, exp_type) {
  $.post(
    "https://students.tradingcafeindia.com/tc_indicator/op_bargraph",
...
function call_Dial_API(script, exp_date, exp_type) {
  $.post(
    "https://students.tradingcafeindia.com/tc_indicator/op_dial",
    { script: script, exp: exp_date, exp_type: exp_type },
    function (data, status) {
      Dial_data = data;
    }
...
$(document).ready(function () {
  ...
  if ($(window).width() < 1115 && $(window).width() > 750) {
    ...
    $(".speedometerWrapper-G5piCoZi")
      ...
      .addClass("large-G5piCoZi");
  } else if ($(window).width() < 370) {
    $(".speedometerWrapper-G5piCoZi")
      .removeClass("large-G5piCoZi")
      .addClass("small-G5piCoZi");
  }
